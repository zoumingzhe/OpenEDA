...
void LibBuilder::__buildAttrMap(void) {
    attr_builder_map_ = {
        ...
        {"isMacroCell", BINDA(__buildIsMacroCell)},
        {"isPad", BINDA(__buildIsPad)},
        {"isDecapCell", BINDA(__buildIsDecapCell)},
        {"isFillerCell", BINDA(__buildIsFillerCell)},
        {"isTapCell", BINDA(__buildIsTapCell)},
        {"isClockGatingCell", BINDA(__buildIsClockGatingCell)},
        {"isClockIsolationCell", BINDA(__buildIsClockIsolationCell)},
        {"isIsolationCell", BINDA(__buildIsIsolationCell)},
        {"isNoEnable", BINDA(__buildIsNoEnable)},
        {"clock_gating_integrated_cell",
         BINDA(__buildClockGatingIntegratedCell)},
        {"antenna_diode_type", BINDA(__buildAntennaDiodeType)},
        {"isLevelShifter", BINDA(__buildIsLevelShifter)},
