...
from dreamplace.ops.electric_potential.electric_overflow import plot as epplot
...
class DensityPotentialFunction(Function):
    ...
    def forward(
        ...
        if plot_count % 100 == 0: 
            ...
            epplot(plot_count, output[1].clone().div(bin_size_x*bin_size_y).cpu().numpy(), padding, 'summary_dp/potential_map'% (plot_count))
        plot_count += 1
